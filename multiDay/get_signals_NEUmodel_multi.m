function Fcell = get_signals_NEUmodel_multi(stat, res, ops, iplane)
...
covLreg= covL((1+ops.Nk):end, (1+ops.Nk):end);
covLinv = inv(covLreg + 1e-4 * eye(size(covLreg,1)));
