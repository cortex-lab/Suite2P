...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @gui2p_old_OpeningFcn, ...
                   'gui_OutputFcn',  @gui2p_old_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before gui2p_old is made visible.
function gui2p_old_OpeningFcn(hObject, eventdata, h, varargin)
% This function has no output args, see OutputFcn.
% varargin   command line arguments to gui2p_old (see VARARGIN)
...
h.output = hObject;
guidata(hObject, h);
% UIWAIT makes gui2p_old wait for user response (see UIRESUME)
% uiwait(h.figure1);

% --- Outputs from this function are returned to the command line.
function varargout = gui2p_old_OutputFcn(hObject, eventdata, h) 
...
pb = [84 93 101 86 87 89 90 92 103 98 95 96 99 100 1 2 104 112];
for j = 1:numel(pb)
